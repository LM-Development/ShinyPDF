...
namespace ShinyPDF.Previewer
{
    internal class PreviewerWindowViewModel : ReactiveObject
    {
        ...
        public PreviewerWindowViewModel()
        {
            ...
            ShowDocumentationCommand = ReactiveCommand.Create(() => OpenLink("https://github.com/LM-Development/ShinyPDF"));
            SponsorProjectCommand = ReactiveCommand.Create(() => OpenLink("https://github.com/sponsors/LM-Development"));
        }
