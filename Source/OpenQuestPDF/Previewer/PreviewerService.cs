    ...
    internal class PreviewerService
    {
        ...
        private void StartPreviewer()
        {
            ...
            catch
            {
                throw new Exception("Cannot start the QuestPDF Previewer tool. " +
                                    "Please install it by executing in terminal the following command: 'dotnet tool install --global OpenQuestPDF.Previewer'.");
            }
        }
        ...
        private void CheckVersionCompatibility(Version version)
        {
            ...
            throw new Exception($"Previewer version is not compatible. Possible solutions: " +
                                ...
                                $"2) Update the QuestPDF previewer tool using the following command: 'dotnet tool update --global OpenQuestPDF.Previewer --version {RequiredPreviewerVersionMajor}.{RequiredPreviewerVersionMinor}'");
        }
