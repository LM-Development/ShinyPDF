                ...
                .RenderDocument(document =>
                {
                    document.Page(page =>
                    {
                        ...
                        page.Content().Column(column =>
                        {
                            ...
                            column.Item()
                                .Text("example invoice") //.Text("مثال على الفاتورة") // example invoice
                            ...
                            column.Item().Table(table =>
                            {
                                ...
                                table.Cell().Element(HeaderStyle).Text("item description");
                                table.Cell().Element(HeaderStyle).Text("quantity");
                                table.Cell().Element(HeaderStyle).Text("price");
