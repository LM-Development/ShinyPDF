            ...
            where TCanvas : ICanvas, IRenderingCanvas
        {
            ...
            void ThrowLayoutException()
            {
                var message = $"Composed layout generates infinite document. This may happen in two cases. " +
                              ...
                              $"In this case, please increase the value {nameof(ShinyPDF)}.{nameof(Settings)}.{nameof(Settings.DocumentLayoutExceptionThreshold)} static property. " +
