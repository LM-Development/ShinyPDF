...
namespace ShinyPDF.Elements.Text
{
    internal static class FontFallback
    {
        ...
        public static IEnumerable<TextRun> SplitWithFontFallback(this string text, TextStyle textStyle)
        {
            ...
            {
                bool hasSeenDefaultFallback = false;
                while (textStyle != null)
                {
                    ...
                    if (textStyle == null && !hasSeenDefaultFallback)
                    {
                        textStyle = TextStyle.LibraryDefault;
                        hasSeenDefaultFallback = true;
                    }
                }
            }
