...
namespace ShinyPDF.Fluent
{
    ...
    {
        [Obsolete("This element is deprecated, and might be removed in a later Version. Please use the Table element, or the combination of the Row and Column elements.")]
